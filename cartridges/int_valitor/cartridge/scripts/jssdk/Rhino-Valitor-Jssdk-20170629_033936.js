...
function ValitorFactory() {
}

/**
 * @returns {MerchantApi}
 */
ValitorFactory.prototype.getMerchantApi = function(username, password, url) {
 ...
 */
ValitorFactory.prototype.getProcessorApi = function(username, password, url) {
 ...
 * @returns {Logger}
 */
ValitorFactory.prototype.getLogger = function() {
	return new Logger();
};
 ...
 * @returns {BaseApi}
 */
ValitorFactory.prototype.getBaseApi = function() {
	return new BaseApi();
};
 ...
 * @returns {Http}
 */
ValitorFactory.prototype.getHttp = function() {
	return new Http();
};
 ...
 * @returns {Xml}
 */
ValitorFactory.prototype.getXml = function() {
	return new Xml();
};
 ...
 */
ValitorFactory.prototype.getPaymentRequestBase = function() {
 ...
 */
ValitorFactory.prototype.getPaymentRequest = function() {
 ...
 */
ValitorFactory.prototype.getInitiatePaymentRequest = function() {
 ...
 */
ValitorFactory.prototype.getInvoiceReservationRequest = function() {
 ...
 */
ValitorFactory.prototype.getCaptureRequest = function() {
 ...
 */
ValitorFactory.prototype.getRefundRequest = function() {
 ...
 */
ValitorFactory.prototype.getReleaseRequest = function() {
 ...
 */
ValitorFactory.prototype.getChargeRequest = function() {
 ...
 * @returns {CreditCard}
 */
ValitorFactory.prototype.getCreditCard = function() {
 ...
 * @returns {BaseRequest}
 */
ValitorFactory.prototype.getBaseRequest = function() {
 ...
 * @returns {PaymentInfo}
 */
ValitorFactory.prototype.getPaymentInfo = function() {
 ...
 * @returns {OrderLine}
 */
ValitorFactory.prototype.getOrderLine = function() {
 ...
 */
ValitorFactory.prototype.getCustomerInfo = function() {
 ...
 */
ValitorFactory.prototype.getCustomerAddress = function() {
 ...
 */
ValitorFactory.prototype.getPaymentRequestConfig = function() {
 ...
 */
ValitorFactory.prototype.getVerify3dSecureRequest = function(transactionId, paRes) {
 ...
 * @returns {DateHelper}
 */
ValitorFactory.prototype.getDateHelper = function() {
 ...
 */
ValitorFactory.prototype.getResponseFactory = function () {
 ...
 * @returns {ResponseFactory}
 */
ValitorFactory.prototype.getBase64 = function () {
	return new Base64();
};
 ...
 * @returns {HttpHelper}
 */
ValitorFactory.prototype.getHttpHelper = function() {
 ...
 */
ValitorFactory.prototype.getPaymentsRequest = function() {
 ...
 */
ValitorFactory.prototype.getFundingsRequest = function() {
...
/**
 * Connector for the Valitor Merchant API
 *
 * @param username The API username for Valitor
 * @param password The API user's password
 * @param url The url for the gateway (e.g. "testgateway.pensio.com")
 * @param factory {ValitorFactory}
 * @param logger {Logger}
 * @param http {Http}
...
/**
 * Connector for the Valitor Processor API.
 *
 * @param username The API username for Valitor
 * @param password The API user's password
 * @param url The url for the gateway (e.g. "testgateway.pensio.com")
 ...
 *
 * @param baseFactory {ValitorFactory}
 * @extends {ValitorFactory}
 * @constructor
 */
function RhinoValitorFactory(baseFactory) {
 ...
 * @returns {Http}
 */
RhinoValitorFactory.prototype.getHttp = function() {
...
if (module != undefined) {
    ...
    module.exports = {
        ...
        RhinoValitorFactory: RhinoValitorFactory,
        ValitorFactory: ValitorFactory,
        RhinoHttp: RhinoHttp
    }
